...
"""Ре, Ми, До, До, Соль (второй До звучит на октаву ниже).
Длительности в этой версии: четверть, четверть, восьмая, восьмая, четверть.
"""
...
def play_motif(
    ...
    for note, octave, mult in sequence:
        ...
        # Выводим параметры текущей ноты для наглядности.
